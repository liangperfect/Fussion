...
public class CameraManagerFactory {
    ...
    private static AndroidCameraManagerImpl sAndroidCameraManager2;
    ...
    public static synchronized CameraManager getAndroidCameraManager2() {
        if (sAndroidCameraManager2 == null) {
            sAndroidCameraManager2 = new AndroidCameraManagerImpl();
        }
        return sAndroidCameraManager2;
    }
}
