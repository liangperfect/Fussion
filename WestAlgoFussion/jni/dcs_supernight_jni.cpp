...
jint  init(JNIEnv *env, jobject thiz,jint width,jint height){
    LOGE("dcs_supernight_jni init");
	return dcs_supernight_init(width,height);
}

jint setParameters(JNIEnv *env,jobject thiz,jint rgbIso,jint monoIso){
...
jint setImagePair(JNIEnv *env,jobject thiz,jbyteArray mainY,jbyteArray mainUV,jint mainW,jint mainH,jint mainFormat,jint mainRotation,jint main_s0,jint main_s1,
...
jint generate(JNIEnv *env,jobject thiz,jbyteArray supernightY,jbyteArray supernightUV){
